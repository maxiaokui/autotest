...
public class TestRandomUtil {
	 ...
	 * 
	 * @Title: getRandom   
	 * @Description: 输入一个最小的值，再输入一个值，那最大的值为mix+max
	 * @param: @param mix
	 * @param: @param max
	 * @param: @return      
	 * @return: int      
     ...
     * 
     * @Title: main   
     * @Description: 得到mix和mix+max范围内的值
     * @param: @param args      
     * @return: void      
     * @throws
     */
     ...
     * @Description: 输入一个字符串 随机返回一个和当前字符串长度一样的值
     * @param: @param string
     * @param: @return      
     * @return: String      
     * @throws
